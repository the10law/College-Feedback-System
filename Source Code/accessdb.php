...
<title>SIT | Accessing Database</title>
...
?>
<b class=""
<b class="alert-warning ">WARNING:</b>You are required to be an authorised user in order to access the database. Please provide your login credentials below to gain acces to the database!!</center><br />
