...
<title>SIT | UPDATE Subject_Master</title>
...
Term<input type="text" name="term" class="form-control" />
Code<input type="text" name="code" class="form-control" />
Course<input type="text" name="course" class="form-control" />
Teacher<input type="text" name="teacher" class="form-control" />
...
<?php
if(isset($_POST["dept"]) && isset($_POST["term"]) && isset($_POST["code"]) && isset($_POST["course"]) && isset($_POST["teacher"]))
{
$dept=$_POST["dept"];
$term=$_POST["term"];
$code=$_POST["code"];
...
$course="'$course'";
$teacher="'$teacher'";
$qry="update sub_mas set Dept=$dept, Term=$term, Course=$course, Teacher=$teacher where Code=$code";
